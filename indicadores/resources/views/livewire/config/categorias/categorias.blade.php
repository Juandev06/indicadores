<div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="td-content">
                                            <span
                                                class="badge bg-{{ $categoria->estado == 'A' ? 'success' : 'danger' }}">
                                    ...
                                    @can($permisoEditarModulo)
                                        <td class="text-center no-print">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-danger btn-sm"
                                                onClick="Confirm('{{ $categoria->id }}')" title="Eliminar">
                                                <i class="ico-trash"></i>
                                            </a>
                                        </td>
                                    @endcan
    ...
    @include('livewire.config.categorias.form')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.livewire.on('cat-indicators', msg => {
                setError(msg);
            });
